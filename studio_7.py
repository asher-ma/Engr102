...
def main():
    ...
    #print top 5 industries by salary. Only include industries with at least 10 participants
    ...
    # Average salary breakdown by highest level of education
    print("\nAnswer #4: Average salary by education")
    education_level = group_by_attribute(participants, "education")
    average_salaries_by_education = get_average_salary(education_level)

    for group in average_salaries_by_education:
        print(group.key, group.average)

    # Average salary breakdown by years of experience in field
    print("\nAnswer #5: Average salary by experience")
    experience = group_by_attribute(participants, "experience")
    average_salaries_by_experience = get_average_salary(experience)
