...
def main():
    ...
    my_name = "Asher" # put your name inside of the quotes
    my_favorite_color = "Orange" # put your favorite color inside of the quotes
...
def module_7_loops():
    ...
    # For loops are used to iterate through a list of items.
